...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center">ONLINE BANK</a>
...
?> 
                    ...
                    <div class="card-body"style="margin-top:0px;background-color:GREY;border-radius:10px;color:white">
          ...
          <div class="col-sm-4">
                <div class="card text-center" style="margin-top:76px;background-color:GREY;border-radius:10px;color:white">
